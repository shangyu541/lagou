...
public class AutodeliverController {
    ...
    //    String url = "http://lagou-service-resume-nacos/resume/openstate/" + userId;  // 指定服务名
    //    Integer forObject = restTemplate.getForObject(url, Integer.class);
    //    return forObject;
    //}
    ...
    @SentinelResource(value = "checkStateFeign",blockHandlerClass = SentinelFallbackClass.class,
            blockHandler = "handlerException",fallback = "handleError",
